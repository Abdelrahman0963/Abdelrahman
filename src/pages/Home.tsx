...
const Home: React.FC = () => {
  function DownloadPDF() {
    ...
    link.href = "../../public/Resume/Abdelrahman Resume.pdf";
  ...
  return (
    <>
      <section
        ...
        id="home"
        className="home-section w-full h-[100%] bg-cover bg-center flex items-center  justify-center relative z-0 overflow-hidden "
      >
